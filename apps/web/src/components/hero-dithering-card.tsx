...
export function CTASection() {
	...
	return (
		<section className="py-12 w-full flex justify-center items-center px-4 md:px-6 select-none">
			<div
				...
				<div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
					...
					<div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
						...
						<p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
							Join 2,847 founders using the only AI that
							understands the nuance of your voice. Clean,
